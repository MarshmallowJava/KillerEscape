...
execute store success score @s var anchored eyes positioned ^ ^ ^ anchored feet positioned ^ ^ ^1 if entity @e[tag=communicator,tag=current_map,tag=repairable,tag=!repaired,distance=..1]
