...
data modify storage minecraft:killerescape storage append value {id:"minecraft:warped_fungus_on_a_stick",tag:{CustomModelData:1,CustomTag:dash,OwnItem:1b,display:{Name:'{"text":"疾走","italic":false,"color":"yellow"}',Lore:['{"text":"1秒間移動速度が上昇する","italic":false,"color":"white"}']}},Count:1b}
