...
execute if score ban var matches 0 run data modify storage minecraft:temp temp3 set from storage minecraft:temp temp[0].Items[0]
...
execute if score ban var matches 0.. run data modify storage minecraft:temp temp3.tag.display.Name set from storage minecraft:temp temp[0].Items[0].tag.display.Name
execute if score ban var matches 0.. run data modify storage minecraft:temp temp3.tag.display.Lore set from storage minecraft:temp temp[0].Items[0].tag.display.Lore
...
execute if score count var matches 1.. run function killerescape:config/ban/paint/_
