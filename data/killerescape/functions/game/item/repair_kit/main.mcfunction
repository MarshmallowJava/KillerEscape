...
#スキルチェック中止
execute as @a[scores={skillcheck_time=-2147483648..2147483647}] at @a anchored eyes positioned ^ ^ ^ anchored feet positioned ^ ^ ^1 unless entity @e[tag=communicator,tag=current_map,tag=repairable,tag=!repaired,distance=..1] run scoreboard players reset @s skillcheck_time
