...
execute if entity @s[tag=mode_choose,scores={cool_vampire=0}] run function killerescape:game/killer/vampire/tick/___

#モードシフト
execute store result score @s var if entity @s[tag=mode_choose]
scoreboard players add @s[tag=offhand_action,scores={cool_vampire=0}] var 1
