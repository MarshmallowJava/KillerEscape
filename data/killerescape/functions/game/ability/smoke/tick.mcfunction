...
#不可視を付与
execute if score @s time matches 20.. run effect give @e[distance=..2] minecraft:invisibility 1 0 true
execute if score @s time matches 20.. run effect clear @e[distance=..2] minecraft:glowing
