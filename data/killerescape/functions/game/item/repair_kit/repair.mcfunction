...
#修理
execute anchored eyes positioned ^ ^ ^ anchored feet positioned ^ ^ ^1 run tag @e[tag=communicator,tag=current_map,tag=repairable,tag=!repaired,distance=..1] add repairing
