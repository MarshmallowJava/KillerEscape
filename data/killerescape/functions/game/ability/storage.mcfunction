...
data modify storage minecraft:killerescape storage append value {id: "minecraft:clock", Count: 1b, tag: {CustomTag: "ability_work_hard", CustomModelData: 104, display: {Lore: ['{"text":"医療キットの使用効率が上昇する","italic":false,"color":"white"}', '{"text":"パッシブ","italic":false,"color":"blue"}'], Name: '{"text":"懸命","italic":false,"color":"aqua"}'}}}
data modify storage minecraft:killerescape storage append value {id: "minecraft:clock", Count: 1b, tag: {CustomTag: "ability_alert", CustomModelData: 105, display: {Lore: ['{"text":"フックから救助した時、鬼が一定時間ハイライトされる","italic":false,"color":"white"}', '{"text":"パッシブ","italic":false,"color":"blue"}'], Name: '{"text":"警戒","italic":false,"color":"aqua"}'}}}
#UNUSED
