...
data modify storage minecraft:killerescape killers append value {Name:'{"text":"影鬼","italic":false,"color":"dark_aqua"}',Items:[{id:"minecraft:warped_fungus_on_a_stick",tag:{display:{Name:'{"text":"影鬼","italic":false,"color":"dark_aqua"}',Lore:['{"text":"壁越しに、影を用いた拘束を行う","italic":false,"color":"white"}']},CustomModelData:13,CustomTag:Shadow,OwnItem:1b,HideFlags:255},Count:1b}]}
