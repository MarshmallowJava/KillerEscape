...
execute if score @s sabotage_time matches 1.. if data block 0 0 0 Items[{tag:{CustomTag:KillerWeapon}}] if score now var matches 22 at @e[tag=communicator,limit=1,sort=nearest] run particle minecraft:crit ^ ^0.5 ^1 0 0 0 1 10 force @a
...
execute if score @s sabotage_time matches 1.. if data block 0 0 0 Items[{tag:{CustomTag:KillerWeapon}}] if score now var matches 35 at @e[tag=communicator,limit=1,sort=nearest] run particle minecraft:crit ^ ^0.5 ^1 0 0 0 1 10 force @a
