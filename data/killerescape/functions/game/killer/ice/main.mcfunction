...
#能力者ごとに処理
execute as @a[nbt={Inventory:[{tag:{CustomTag:Ice}}]},scores={cool_ice=0,ice_time=0,useItem=1},tag=display_ui] at @s run function killerescape:game/killer/ice/launch
