...
#表示
execute if score @s skillcheck_time matches 40.. run title @s[scores={skillcheck_ans=0}] actionbar {"text":"[スニークしないでください！！！]","italic": false,"color": "yellow"}
execute if score @s skillcheck_time matches 40.. run title @s[scores={skillcheck_ans=1}] actionbar {"text":"[スニークしてください！！！]","italic": false,"color": "red"}
...
execute if score @s skillcheck_time matches 50 if score @s skillcheck_ans matches 0 if score @s sneak matches 0 run function killerescape:game/skillcheck/success
execute if score @s skillcheck_time matches 50 if score @s skillcheck_ans matches 1 if score @s sneak matches 0 run function killerescape:game/skillcheck/fail
